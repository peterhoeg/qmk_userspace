{
  ...
  documentation = ''
    Custom configuration for the X-Bows Nature (and Knight)
  '';
  notes = ''
    Pending:
  ...
  layers = [
    [
      ...
      "MO(2)"   "KC_A"    "KC_S"    "KC_D"           "LT(2,KC_F)" "KC_G"    "KC_BSPC" "KC_H"    "KC_J"    "KC_K"    "KC_L"    "KC_SCLN" "KC_QUOT" "KC_BSLS" "KC_PGDN"
      "SC_LSPO" "KC_Z"    "KC_X"    "KC_C"           "KC_V"       "KC_B"    "KC_ENT"  "KC_N"    "KC_M"    "KC_COMM" "KC_DOT"  "KC_SLSH" "SC_RSPC" "KC_UP"
      "KC_LCTL" "KC_LGUI" "KC_LALT" "LCTL_T(KC_ESC)" "KC_CAPS"    "SC_RSPC" "KC_SPC" "KC_RALT" "TG(1)" "KC_RCTL" "KC_LEFT" "KC_DOWN" "KC_RGHT"
    ]
    [
    ...
    [
      ...
      "KC_TRNS" "KC_TRNS" "KC_TRNS" "KC_TRNS"        "KC_TRNS"    "KC_TRNS" "KC_TRNS" "KC_TRNS" "KC_END"  "KC_INS"  "KC_PGDN" "KC_TRNS" "KC_MUTE" "KC_VOLU"
